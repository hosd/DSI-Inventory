...
{ 
    ...
    {
          $this->middleware('permission:order-list-list|product-create|product-edit|product-delete', ['only' => ['index','show']]);
    ...
    public function index()
    {
        ...
        return view('adminpanel.order.index')->with('title',$title)->with('savestatus',$savestatus)->with('count',$count)->with('category',$category)->with('designcode',$designcode)->with('designname',$designname)->with('size',$size)->with('model',$model);
    }
