...
{ 
    ...
    public function index()
    {
        ...
        return view('adminpanel.product.index')->with('title',$title)->with('savestatus',$savestatus)->with('count',$count)->with('category',$category)->with('designcode',$designcode)->with('designname',$designname)->with('size',$size)->with('model',$model);
    }
