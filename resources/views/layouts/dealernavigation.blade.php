...
@endphp
    <div class="sidebar_menu col-lg-2 col-md-4 bg-dark vh-100 px-0 d-md-block d-none">
                    ...
                    <ul class="px-0 " style="list-style:none;">
                        ...
                        <li class="@if ($name == 'stock-list')  active @endif   menu_li"><a class="d-flex" href="{{route('stock-list')}}"><span><img src="{{ asset('public/dealer/images/stickies.svg') }}"></span>Stock management</a></li>
                        <li class="@if ($name == 'dealer-user-profile')  active @endif  menu_li"><a class="d-flex" href="{{route('dealer-user-profile')}}"><span><img src="{{ asset('public/dealer/images/Vector.svg') }}"></span>Profile management</a></li>
                        <li class="@if ($name == 'user-list')  active @endif  menu_li"><a class="d-flex" href="{{route('user-list')}}"><span><img src="{{ asset('public/dealer/images/list.svg') }}"></span>Current User List</a></li>
                    </ul>
                    <!-- </div> -->
                </div>
                ...
                <div class="sticky_header bg-white">
                            ...
                            <div>
                                ...
                                <div class="mobile_menu offcanvas-body">
                                    <ul class="px-0 " style="list-style:none;">
                                        ...
                                        <li class="@if ($name == 'stock-list')  active @endif menu_li"><a href="{{route('stock-list')}}"><span><img class="icon_img" src="{{ asset('public/dealer/images/stickies.svg') }}"></span>Stock management</a></li>
                                        <li class="@if ($name == 'dealer-user-profile')  active @endif  menu_li"><a href="{{route('dealer-user-profile')}}"><span><img class="icon_img" src="{{ asset('public/dealer/images/Vector.svg') }}"></span>Profile management</a></li>
                                        <li class="@if ($name == 'user-list')  active @endif  menu_li"><a href="{{route('user-list')}}"><span><img class="icon_img" src="{{ asset('public/dealer/images/list.svg') }}"></span>Current User List</a></li>
                                    </ul>
                                </div>
                                <!-- Mobile Menu End -->
                        ...
                        <div class="col-lg-12 col-6 text-end">
                            <a href="{{route('dealer-user-profile')}}"><img src="{{ asset('public/dealer/images/account.svg') }}"></a>
