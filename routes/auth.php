...
//    Route::get('adminpanel/blockmainslider/{id}', [MainSliderController::class, 'block'])->name('blockmainslider');
    ...
    Route::get('get-state-cities', [DealersContoller::class, 'get_state_cities']) ->name('get-state-cities');
    ...
    Route::get('stock-list', [DealerloginContoller::class, 'stock_list'])->name('stock-list'); 
    ...
    Route::get('user-list', [DealerloginContoller::class, 'user_list'])->name('user-list'); 
    ...
    Route::get('dealer-user-profile', [DealerloginContoller::class, 'dealer_user_profile'])->name('dealer-user-profile');
    Route::post('/save-user-profile', [DealerloginContoller::class, 'save_user_profile'])->name('save-user-profile');
});